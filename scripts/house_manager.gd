...
func _load_data() -> void:
	var fallback := {
		"houses": [
			{"id": 1, "name": "House 1", "capacity": 5, "occupants": 1, "founding_day": 0},
			{"id": 2, "name": "House 2", "capacity": 5, "occupants": 1, "founding_day": 0},
			{"id": 3, "name": "House 3", "capacity": 5, "occupants": 1, "founding_day": 0},
			{"id": 4, "name": "House 4", "capacity": 5, "occupants": 1, "founding_day": 0},
			{"id": 5, "name": "House 5", "capacity": 5, "occupants": 1, "founding_day": 0}
		],
